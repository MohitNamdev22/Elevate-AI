        ...
        <div className="relative z-10 container mx-auto px-4 pt-8">
          ...
          <header className="flex justify-between items-center mb-8">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-lg">ElevateAI</span>
            </div>
          ...
          <div className="flex mt-12">
            ...
            <div className="w-1/4">
              <div className="relative">
                ...
                <img src={image3} alt="Professional" className="rounded-2xl w-36 ml-44 mt-8" />
              </div>
            </div>
            ...
            <div className="w-1/2 px-12 text-center">
              {/* Top Banner */}
              <div className="bg-blue-50 text-blue-600 py-2 px-4 rounded-full inline-block mb-8">
